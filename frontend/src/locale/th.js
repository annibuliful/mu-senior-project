...
export default {
  ...
  noFamily: "กรุณาเพิ่มสมาชิกในครอบครัวก่อนใช้ฟีเจอร์นี้",
  developBy: "แอปพลิเคชันนี้พัฒนาโดย",
  noNotiNow: "ยังไม่มีการแจ้งเตือนในเร็วๆนี้",
  home: "การนัดหมาย",
  vaccine: "วัคซีน",
  ...
  vaccineDetailsPage: {
    ...
    vaccineReference2:
      "คู่มือ แนวทางการให้วัคซีนโควิด 19 โดย กรมควบคุมโรค พ.ศ. 2564"
  },
  vaccinePackagerPage: {
  ...
  label: {
    addVaccine: "เพิ่มวัคซีนเข้าแผนการฉีด",
