<template>
  <div>
    <p class="text-2xl mb-10 border-b-2 border-gray-700" style="width: auto;">
      {{ familyword }}
    </p>
    <div class="mt-8">
      <button
        @click="onOpenAddFamilyForm"
        class="block bg-white hover:bg-gray-100 text-black-800 py-2 px-4 border border-gray-900 rounded shadow ml-auto mr-2"
      >
      ...
      <div class="mt-4 w-full sm:mb-20 lg:mb-4">
        ...
        >
          <FamilyCard
            class="border-orange-400 shadow-md py-2 border-solid border-2 rounded-full"
            :id="family.familyId"
